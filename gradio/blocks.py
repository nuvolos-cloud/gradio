        ...
        if inline:
            ...
            try:
                ...
                if self.is_nuvolos:
                    ...
                    display(
                        HTML(
                            f"""<div><iframe src="{self.proxy_url}" width="{self.width}" allow="autoplay; camera; microphone; clipboard-read; clipboard-write;" frameborder="0" allowfullscreen onload='javascript:(function(o){{o.style.height=o.contentWindow.document.body.scrollHeight+"px";}}(this));' style="height:500px;width:100%;border:none;overflow:hidden;"></iframe></div>"""
                        )
                    )
